...
`POST /api/print/complex-doc` или `POST /api/print`

Содержимое запроса и содержимое ответа описаны по [данной ссылке](https://www.notion.so/V2-b4db6fd4b3c54d73b06e6db6c00b06c5#e3c0b62e6bec47bba44051f4fcf7f7a8). Использована версия описания на дату 21.12.2021. Ниже приведены скриншоты этой версии.

![Описание API от заказчика](Source/Images/s06.jpg "Описание API от заказчика")

![Описание API от заказчика](Source/Images/s07.jpg "Описание API от заказчика")

![Описание API от заказчика](Source/Images/s08.jpg "Описание API от заказчика")
